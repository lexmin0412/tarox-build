...
class Project extends creator_1.default {
    ...
    create() {
        this.fetchTemplates()
            ...
            .catch(err => console.log(helper_1.chalk.red('创建项目失败: ', err)));
    }
    fetchTemplates() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!conf.templateSource) {
                ...
                if (!homedir) {
                    ...
                    conf.templateSource = helper_1.DEFAULT_TEMPLATE_SRC;
                }
                ...
                if (fs.existsSync(taroConfig)) {
                    ...
                    conf.templateSource = config && config.templateSource ? config.templateSource : helper_1.DEFAULT_TEMPLATE_SRC;
                }
                else {

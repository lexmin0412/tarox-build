...
class Compiler {
    ...
    constructor(appPath) {
        ...
        this.projectConfig = require(helper_1.resolveScriptPath(path.join(appPath, helper_1.PROJECT_CONFIG), 'rn'))(_.merge);
        ...
        this.entryFilePath = helper_1.resolveScriptPath(path.join(this.sourceDir, config_1.default.ENTRY), 'rn');
...
function build(appPath, buildConfig) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield util_1.checkCliAndFrameworkVersion(appPath, 'rn');
        ...
        if (compiler.rnConfig.onlyTaroToRn)
            return;
        if (watch) {
            compiler.watchFiles();

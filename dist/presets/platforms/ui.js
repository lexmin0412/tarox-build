    ...
    ctx.registerPlatform({
        ...
        fn({ config }) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const { H5_OUTPUT_NAME, RN_OUTPUT_NAME, TEMP_DIR, RN_TEMP_DIR, WEAPP_OUTPUT_NAME, QUICKAPP_OUTPUT_NAME, copyFileToDist, analyzeStyleFilesImport, analyzeFiles } = require('../../ui/common');
                ...
                const buildHooks = { modifyWebpackChain, modifyBuildAssets, onBuildFinish };
            ...
            module.exports.default = module.exports
              ...
              module.exports.default = module.exports
                ...
                buildEntry(uiIndex);
                if (platforms && Array.isArray(platforms)) {
                    platforms.includes(PLATFORMS.WEAPP) && (yield buildForWeapp(buildData));
                    platforms.includes(PLATFORMS.QUICKAPP) && (yield buildForQuickapp(buildData));
                    platforms.includes(PLATFORMS.H5) && (yield buildForH5(uiIndex, buildData, buildHooks));
                    platforms.includes(PLATFORMS.RN) && (yield buildForRN(uiIndex, buildData));
                }
                else {
                    yield buildForWeapp(buildData);
                    yield buildForH5(uiIndex, buildData, buildHooks);
                }
                if (isWatch) {
                    watchFiles();
                }

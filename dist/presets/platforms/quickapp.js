    ...
    ctx.registerPlatform({
        ...
        fn({ config }) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const { isWatch, port, release } = ctx.runOpts;
                const { npm, fs, printLog, processTypeEnum, chalk, shouldUseYarn, isWindows, shouldUseCnpm, unzip } = ctx.helper;
                ...
                // 准备 miniRunner 参数
                const miniRunnerOpts = Object.assign({}, config, { nodeModulesPath, buildAdapter: config.platform, isBuildPlugin: false, globalObject: 'global', fileType: {
                        templ: '.ux',
                        style: '.css',
                        config: '.json',
                        script: '.js'
                    }, isUseComponentBuildPage: false, quickappJSON, isBuildQuickapp: true });
                ...
                const isReady = yield prepareQuickAppEnvironment({
                    originalOutputRoot,
                    fs,
                    appPath,
                    chalk,
...
function prepareQuickAppEnvironment({ originalOutputRoot, fs, appPath, chalk, shouldUseYarn, isWindows, shouldUseCnpm, unzip }) {
    return __awaiter(this, void 0, void 0, function* () {
        let isReady = false;
        ...
        if (needDownload) {
            ...
            yield dowload_1.downloadGithubRepoLatestRelease('NervJS/quickapp-container', appPath, originalOutputRoot);
            yield unzip(path.join(originalOutputRoot, 'download_temp.zip'));
...
function runQuickApp({ isWatch, originalOutputRoot, port, release }) {
    return __awaiter(this, void 0, void 0, function* () {
